...
func (z *MiddleMessage) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *MiddleMessage) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *MiddleMessage) Msgsize() (s int) {
	s = 1 + 4 + msgp.Int64Size + 7 + msgp.Int64Size + 8 + msgp.StringPrefixSize + len(z.Content) + 13 + msgp.TimeSize
	return
}
